...
const {WCATable} = require('../models/WCA')

const yearsIndividualPostWCA = async (req, res) => {
    const yearsData = req.body;
    console.log(yearsData);

    try {
        const year = await WCATable.findOne({
        ...
        await WCATable.create(yearsData)
            .then((data) => {
...
const yearsIndividualWCA = async(req,res)=>{
...
module.exports = { yearsIndividualPostWCA, yearsIndividualWCA };
