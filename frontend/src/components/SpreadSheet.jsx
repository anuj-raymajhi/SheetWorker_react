...
// useEffect for dropdown (WCA) worksheet
                ...
                update.push( 
                    {
                        ...
                        index: ColIndex,
                        isReadOnly: true,
                        formula: `=SUM(${currCol}4:${currCol}6)`
                    }
                )
                ColIndex += 1
            }
                ...
                update.push( 
                    {
                        ...
                        index: ColIndex,
                        isReadOnly: true,
                        formula: `='BSheet & Ratios'!${BSheetCol}12`
                    }
                )
                ColIndex += 1
            }
    ...
    // useEffect for net working capital requirement row
    useEffect(()=>{
        if(years) {
            var time_in_years = years.yearEnd - years.yearStart + 1;
            var ColIndex = 1;
            ...
            setDropRowSheet(prevState => ({
                ...prevState, 
                net_working_capital_requirement : [
                    ...prevState.net_working_capital_requirement,
                    ...update
                ]
            }))
        }
    ...
    // useEffect for bank finance row
    useEffect(()=>{
        if(years) {
            var time_in_years = years.yearEnd - years.yearStart + 1;
            var ColIndex = 1;
                ...
                update.push( 
                    {
                        ...
                        index: ColIndex,
                        isReadOnly: true,
                        formula: `='BSheet & Ratios'!${BSheetCol}11`
                    }
                )
                ColIndex += 1
            }
    ...
    // useEffect for equity finance (H-I) row
    useEffect(()=>{
        if(years) {
            var time_in_years = years.yearEnd - years.yearStart + 1;
            var ColIndex = 1;
                ...
                <SheetsDirective>
                    ...
                    <SheetDirective name='% Drawdown (WCA)'>
                        <RowsDirective>
                            ...
                            {/*(D) total current assets row */}
                            <RowDirective>
                                <CellsDirective>
                                    {
                                        dropRowSheet.total_current_assets.map(
                                            (value, index) => {
                                                return (
                                                    <CellDirective
                                                        key={index}
                            ...
                            {/*(H) net working capital requirement (D-G) row */}
                            <RowDirective>
                                <CellsDirective>
                                    {
                                        dropRowSheet.net_working_capital_requirement.map(
                                            (value, index) => {
                                                return (
                                                    <CellDirective
                                                        key={index}
                            ...
                            <RowDirective>
                                <CellsDirective>
                                    {
                                        dropRowSheet.nic_asia_bank.map(
                                            (value, index) => {
                                                return (
                                                    <CellDirective
                                                        key={index}
